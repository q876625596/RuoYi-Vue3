<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
            ...
            <el-form-item label="登录设备类型" label-width="auto" prop="loginDeviceType">
                <el-select
                        v-model="queryParams.loginDeviceType"
                        placeholder="登录设备类型"
                        clearable
                        style="width: 240px"
                >
        ...
        <el-table ref="loginInfoRef" v-loading="loading" :data="loginInfoList" @selection-change="handleSelectionChange"
            ...
            <el-table-column label="登录设备类型" align="center" prop="loginDeviceType">
                <template #default="scope">
                    <dict-tag :options="sys_device_type" :value="scope.row.loginDeviceType"/>
                </template>
            </el-table-column>
