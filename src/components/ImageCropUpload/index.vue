<template>
  <div class="user-info-head" @click="editCropper()"><img :src="options.img" :title="'点击' + title"
  ...
  <el-dialog :title="title" v-model="open" width="800px" append-to-body @opened="modalOpened" @close="closeDialog">
    <el-row>
      ...
      <el-col :xs="24" :md="12" :style="{height: '350px'}">
        <div :class="displayImageCircle ? 'image-upload-preview-circle' : 'image-upload-preview'">
...
props.options.img = props.defaultImage;
...
function beforeUpload(file) {
  if (file.type.indexOf("image/") == -1) {
    ...
    reader.onload = () => {
      props.options.img = reader.result;
    };
  }
};
...
.user-info-head:hover:after {
  ...
  cursor: pointer;
  line-height: v-bind(displayImageHeight);
